...
function About() {
  return (
    <div className='bg-gradient-to-b from-[#dad7cd] to-[#ffffff] text-[#3a5a40] pt-[50px] pb-[50px] p-4  '>
        ...
        <div className='space-y-4 text-black md:px-[40px]'>
        ...
        <h2 className="text-3xl sm:text-5xl lg:text-4xl text-center bg-clip-text text-transparent bg-gradient-to-b from-[#3a5a40] via-[#3a5a40] to-black bg-[length:100%_100%] bg-gradient-stops-90-10 font-unbounded mt-10 text-[#3a5a40]">
        Lets get to know each other.       
      </h2>
      <h1 className="text-3xl  sm:text-5xl lg:text-4xl text-center bg-clip-text text-transparent bg-gradient-to-b from-[#3a5a40] via-[#3a5a40] to-black bg-[length:100%_100%] bg-gradient-stops-90-10 font-unbounded  text-[#3a5a40]">
      Get in Touch</h1>
