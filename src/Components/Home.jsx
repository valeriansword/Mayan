  ...
  return (
    ...
    <div className="w-1/2 max-w-4xl xl:max-w-2xl 2xl:max-w-3xl py-8 max-sm:w-full min-xl:grow-0 ">
      ...
      <div className=' flex flex-col justify-center ml-[10px] space-y-[5px] lg:pl-[20px]'>
        ...
        <Link to="/Mayan/Services" className='flex justify-center'><button className='ring-2 font-inter ring-[#3a5a40] max-sm:w-full text-[#dad7cd] bg-gradient-to-b from-[#3a5a40] to-black py-[5px] w-[250px] px-2 rounded-md'>Know More</button></Link>
      </div>
    ...
    <div className=' flex flex-col justify-center ml-[10px] space-y-[5px] lg:pr-[20px]'>
        ...
        <Link to="/Mayan/Products/" className='flex justify-center'><button className='ring-2 font-inter ring-[#3a5a40] max-sm:w-full text-[#dad7cd] bg-gradient-to-b from-[#3a5a40] to-black py-[5px] w-[250px] px-2 rounded-md'>Know More</button></Link>
      </div>
